...
| `verification` | Verification (E4) | `astra-verify`: ephemeral sandboxes per task, dry runs of a drafted config with sample files, and the Snowpark Connect assessment harness. Golden replay and parity grow here. |
